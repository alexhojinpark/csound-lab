...
ik = 1
ip = 0
it = 0       // grain start time
iols = 4   // start overlaps
iole = 0.5     // end overlaps
ioli = (iole - iols)/ign  // overlap increments
while ik <= ign do
 igrate = iols/igdur // grains per sec
 itn = 1/igrate      // grain time increments
 schedule(1, it, igdur, igamp, igfreq, ip)
 ip += itn*its/ifl 
 it += itn        
 iols += ioli
 ik += 1
